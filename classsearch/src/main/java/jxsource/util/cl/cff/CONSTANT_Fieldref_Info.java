...
{	public int tag;
	...
	CONSTANT_Fieldref_Info(int tag, int class_index, int name_and_type_index, int index, Vector constant_pool)
	{	this.tag = tag;
	...
	{	if(obj instanceof CONSTANT_Fieldref_Info)
		{ CONSTANT_Fieldref_Info cmi = (CONSTANT_Fieldref_Info) obj;

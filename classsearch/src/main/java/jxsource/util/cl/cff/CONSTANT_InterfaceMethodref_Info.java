...
{	public int tag;
	...
	CONSTANT_InterfaceMethodref_Info(int tag, int class_index, int name_and_type_index, int index, Vector constant_pool)
	{	this.tag = tag;
	...
	{	if(obj instanceof CONSTANT_InterfaceMethodref_Info)
		{ CONSTANT_InterfaceMethodref_Info cmi = (CONSTANT_InterfaceMethodref_Info) obj;
